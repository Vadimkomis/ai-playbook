...
Centralized AI coding assistant configuration for [Claude Code](https://docs.anthropic.com/en/docs/claude-code) and Codex (this repo includes Codex-specific AGENTS and reusable skills).
